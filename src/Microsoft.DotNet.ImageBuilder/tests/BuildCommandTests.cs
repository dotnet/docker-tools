    ...
    public class BuildCommandTests
    {
        ...
        public async Task BuildCommand_ImageInfoOutput_Basic()
        {
            ...
            using (TempFolderContext tempFolderContext = TestHelper.UseTempFolder())
            {
                ...
                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync($"{runtimeDepsRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync(runtimeDepsDigest);

                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync($"{runtimeRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync(runtimeDigest);

                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync($"{aspnetRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync(aspnetDigest);

                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync(baseImageTag, It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync(baseImageDigest);

                dockerServiceMock
                    .Setup(o => o.GetImageManifestLayersAsync($"{runtimeDepsRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync(runtimeDepsLayers);

                dockerServiceMock
                    .Setup(o => o.GetImageManifestLayersAsync($"{runtimeRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync(runtimeLayers);

                dockerServiceMock
                    .Setup(o => o.GetImageManifestLayersAsync($"{aspnetRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
        ...
        public async Task BuildCommand_NoBaseImage_Cached()
        {
            ...
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDepsRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDepsRepo}:{newTag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
        ...
        public async Task BuildCommand_ImageInfoOutput_CustomDockerfile()
        {
            using (TempFolderContext tempFolderContext = TestHelper.UseTempFolder())
            {
                ...
                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync("runtime:runtime", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync(digest);
            ...
            bool isRuntimeCached)
        {
            ...
            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{runtimeDepsRepoQualified}:{tag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync(runtimeDepsDigest);

            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{overridePrefix}{runtimeDepsRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync(runtimeDepsDigest);

            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{runtimeRepoQualified}:{tag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync(runtimeDigest);

            dockerServiceMock
               .Setup(o => o.GetImageDigestAsync($"{overridePrefix}{runtimeRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
               .ReturnsAsync(runtimeDigest);
        ...
        public async Task BuildCommand_Caching_SharedDockerfile_MissingSourceImageInfoEntry()
        {
            ...
            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{runtimeDepsRepo}:{linuxTag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync(runtimeDepsLinuxDigest);

            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{runtimeDepsRepo}:{windowsTag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync(runtimeDepsWindowsDigest);

            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{runtimeDeps2Repo}:{linuxTag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync(runtimeDeps2Digest);

            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync(linuxBaseImageTag, It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync(runtimeDepsLinuxBaseImageDigest);

            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync(windowsBaseImageTag, It.IsAny<RegistryAuthContext>(), false))
            ...
            dockerServiceMock.Verify(o => o.GetImageDigestAsync(linuxBaseImageTag, It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetImageDigestAsync(windowsBaseImageTag, It.IsAny<RegistryAuthContext>(), false), Times.Once);
            ...
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDepsRepo}:{linuxTag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDepsRepo}:{windowsTag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDeps2Repo}:{linuxTag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetCreatedDate(It.IsAny<string>(), false));
            dockerServiceMock.Verify(o =>
                o.BuildImage(
        ...
        public async Task BuildCommand_Caching_SharedDockerfile_MissingSourceImageInfoEntry_DiffBuildArgs()
        {
            ...
            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{runtimeDeps2Repo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync(runtimeDeps2Digest);

            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{runtimeDeps3Repo}:{tag}", It.IsAny<RegistryAuthContext>(), false))
            ...
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDepsRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDeps2Repo}:{tag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDeps3Repo}:{tag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            ...
            dockerServiceMock.Verify(o => o.GetImageDigestAsync(It.IsAny<string>(), It.IsAny<RegistryAuthContext>(), false));
            dockerServiceMock.Verify(o => o.GetCreatedDate(It.IsAny<string>(), false));
        ...
        public async Task BuildCommand_Caching_SharedDockerfile_NoExistingImageInfoEntries()
        {
            ...
            dockerServiceMock.Verify(o => o.PullImage(baseImageTag, "linux/amd64", false));
            dockerServiceMock.Verify(o => o.GetImageDigestAsync(baseImageTag, It.IsAny<RegistryAuthContext>(), false));
            dockerServiceMock.Verify(o => o.GetImageDigestAsync($"{runtimeDepsRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false));
            dockerServiceMock.Verify(o => o.GetImageDigestAsync($"{runtimeDeps2Repo}:{tag}", It.IsAny<RegistryAuthContext>(), false));
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDepsRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{runtimeDeps2Repo}:{tag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetCreatedDate(It.IsAny<string>(), false));
            dockerServiceMock.Verify(o => o.GetImageArch(baseImageTag, false));
        ...
        public async Task BuildCommand_Caching_TagUpdate()
        {
            ...
            dockerServiceMock.Verify(o => o.GetImageDigestAsync(baseImageTag, It.IsAny<RegistryAuthContext>(), false), Times.Once);
        ...
        public async Task BuildCommand_Caching_SharedDockerfile_TagUpdate()
        {
            ...
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{overridePrefix}{runtimeDepsRepo}:{tag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{overridePrefix}{runtimeDeps2Repo}:{tag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{overridePrefix}{runtimeDeps2Repo}:{newTag}", It.IsAny<RegistryAuthContext>(), false), Times.Once);
            dockerServiceMock.Verify(o =>
                o.BuildImage(
                    It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<IEnumerable<string>>(),
                    It.IsAny<IDictionary<string, string>>(), It.IsAny<bool>(), It.IsAny<bool>()),
        ...
        public async Task BuildCommand_MirroredImages(bool hasCachedImage, string srcBaseImageRepo, string referencedBaseImageRepo)
        {
            ...
            {
                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync($"{Registry}/{RuntimeDepsRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync($"{Registry}/{RuntimeDepsRepo}@{RuntimeDepsDigest}");

                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync($"{Registry}/{RuntimeRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync($"{Registry}/{RuntimeRepo}@{RuntimeDigest}");

                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync($"{Registry}/{AspnetRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync($"{Registry}/{AspnetRepo}@{AspnetDigest}");

                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync($"{RegistryOverride}/{RepoPrefix}{RuntimeDepsRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync($"{RegistryOverride}/{RuntimeDepsRepo}@{RuntimeDepsDigest}");

                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync($"{RegistryOverride}/{RepoPrefix}{RuntimeRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false))
                    .ReturnsAsync($"{RegistryOverride}/{RuntimeRepo}@{RuntimeDigest}");

                dockerServiceMock
                    .Setup(o => o.GetImageDigestAsync($"{RegistryOverride}/{RepoPrefix}{AspnetRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false))
            ...
            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync(mirrorBaseTag, It.IsAny<RegistryAuthContext>(), false))
            ...
            {
                dockerServiceMock.Verify(o => o.GetImageDigestAsync($"{RegistryOverride}/{RepoPrefix}{RuntimeDepsRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false));
                dockerServiceMock.Verify(o => o.GetImageDigestAsync($"{RegistryOverride}/{RepoPrefix}{RuntimeRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false));
            }

            dockerServiceMock.Verify(o => o.GetImageDigestAsync(mirrorBaseTag, It.IsAny<RegistryAuthContext>(), false));

            dockerServiceMock.Verify(o => o.GetImageDigestAsync($"{RegistryOverride}/{RepoPrefix}{AspnetRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false));
            ...
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{RegistryOverride}/{RepoPrefix}{RuntimeDepsRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false));
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{RegistryOverride}/{RepoPrefix}{RuntimeRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false));
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{RegistryOverride}/{RepoPrefix}{AspnetRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false));
        ...
        public async Task BuildCommand_MirroredImages_External(string baseImageRegistry, string manifestRegistry)
        {
            ...
            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{baseImageRepoPrefix}/{RuntimeRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync($"{baseImageRepoPrefix}/{RuntimeRepo}@{RuntimeDigest}");

            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{RegistryOverride}/{SamplesRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false))
            ...
            dockerServiceMock.Verify(o => o.GetImageDigestAsync($"{baseImageRepoPrefix}/{RuntimeRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false));
            dockerServiceMock.Verify(o => o.GetImageDigestAsync($"{RegistryOverride}/{SamplesRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false));
            ...
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{RegistryOverride}/{SamplesRepo}:{Tag}", It.IsAny<RegistryAuthContext>(), false));
        ...
        public async Task BuildCommand_MirroredImages_BaseImageTagOverride()
        {
            ...
            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{baseImageRepoPrefix}/{MirroredBaseTag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync($"{baseImageRepoPrefix}/{MirroredBaseTag}@{RuntimeDigest}");

            dockerServiceMock
                .Setup(o => o.GetImageDigestAsync($"{RegistryOverride}/{SamplesRepo}:{ImageTag}", It.IsAny<RegistryAuthContext>(), false))
                .ReturnsAsync($"{RegistryOverride}/{SamplesRepo}@{SampleDigest}");
            ...
            dockerServiceMock.Verify(o => o.GetImageDigestAsync($"{baseImageRepoPrefix}/{MirroredBaseTag}", It.IsAny<RegistryAuthContext>(), false));
            dockerServiceMock.Verify(o => o.GetImageDigestAsync($"{RegistryOverride}/{SamplesRepo}:{ImageTag}", It.IsAny<RegistryAuthContext>(), false));
            ...
            dockerServiceMock.Verify(o => o.GetImageManifestLayersAsync($"{RegistryOverride}/{SamplesRepo}:{ImageTag}", It.IsAny<RegistryAuthContext>(), false));
