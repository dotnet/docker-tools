...
namespace Microsoft.DotNet.ImageBuilder.Commands
{
    ...
    public class GetStaleImagesCommand : Command<GetStaleImagesOptions, GetStaleImagesOptionsBuilder>
    {
        ...
        {
            ITreesClient treesClient = _octokitClientFactory.CreateTreesClient(Options.GitHubAuthOptions);
            ...
            IBlobsClient blobsClient = _octokitClientFactory.CreateBlobsClient(Options.GitHubAuthOptions);
