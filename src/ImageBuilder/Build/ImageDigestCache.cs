...
/// <summary>
/// Memoizes image digest lookups made while calculating and executing a build plan.
/// </summary>
public sealed class ImageDigestCache(Lazy<IManifestService> manifestService)
{
