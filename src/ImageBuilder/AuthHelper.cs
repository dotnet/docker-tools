...
namespace Microsoft.DotNet.ImageBuilder
{
    ...
    {
        public static Guid GetTenantId(ILogger loggerService, TokenCredential credential)
        {
            ...
            if (tenants.Count() > 1)
            {
                ...
                loggerService.LogInformation("Found more than one tenant. Selecting the first one.");
                loggerService.LogInformation($"Tenants: {allTenantIds}");
            }
